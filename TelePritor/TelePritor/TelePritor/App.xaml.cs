...
using TelePritor.Helpers;
using TelePritor.Services;
using TelePritor.Views;
using Xamarin.Forms;
using Xamarin.Forms.Xaml;

[assembly: XamlCompilation(XamlCompilationOptions.Compile)]
namespace TelePritor
{
	public partial class App : Application
	{
		...
		public static string AzureMobileAppUrl = "https://TelePritor.azurewebsites.net";
